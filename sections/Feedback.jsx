    ...
    >
      ...
      >
        ...
        <p className="mt-[24px] font-normal sm:text-[24px] text-[18px] sm:leading-[45.6px] leading-[39.6px] text-black">
          “Aku selalu yakin dan ini aku tanamkan dari dulu dalam setiap perjalanan hidupku. Setiap langkah kecil yang kita usahakan setiap hari itu, ngga akan pernah sia-sia. Seburuk apapun halaman kamu sebelumnya, tetap harus berusaha untuk melangkah menjadi lebih baik lagi ya?”
        </p>
      </motion.div>
